...
const Card = ({ id, title, price, image }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`mb-4 flex flex-col items-center justify-center hover:shadow-xl transition card ${
        cardIsvisible && "card--animated"
      }`}
    >
      <div className="relative flex-1">
        ...
        <div className="btns absolute bottom-1 right-0 left-0 py-2 px-4 opacity-0 transition flex items-center justify-around">
          <button
            ...
            className="py-2 px-4 bg-gray-900 transition grid items-end rounded text-gray-300 hover:text-gray-900 hover:bg-gray-300 "
          >
