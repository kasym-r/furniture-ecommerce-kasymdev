...
const Cart = () => {
  ...
  let totalPrice = cartProds.reduce(
      ...
      {cartProds.length === 0 ? (
        <div className="w-full pt-24 flex justify-center items-center flex-col gap-6 ">
          <h1 className="text-center text-4xl font-extrabold text-red-400">
            YOUR CART IS STILL EMPTY <i className="fas fa-frown"></i>{" "}
          </h1>
        ...
        <div className=" min-h-screen grid grid-cols-1 lg:grid-cols-5 lg:mb-2">
          ...
          <div className="bg-red-100 lg:col-span-2 px-2 md:px-8 mt-12 lg:mt-0 py-4">
            ...
            <input
              type="text"
              className="outline-none border border-gray-500 p-2 w-full mt-8"
              placeholder="Country"
            />
            <input
              type="text"
            ...
            <button
              type="text"
              className="text-gray-200 bg-gray-900 p-2 w-full mt-8"
            >
              UPDATE
            </button>
            <div className="mt-8 py-4">
              <h1 className="font-bold mb-4">
                Tax : <span className="text-gray-500 ml-12">${tax}</span>{" "}
              </h1>
