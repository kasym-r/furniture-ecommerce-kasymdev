  ...
  return    <div className='mt-8 px-4 min-h-screen w-full pb-2'>
                  ...
                  <div className="lg:px-24 grid grid-cols-1 md:grid-cols-2 grid-rows-5 gap-6">
                        <div className="relative card1 row-span-3 p-24">
                              ...
                              <Link to="/catalog" className="text-white font-bold absolute left-4 top-18 hover:bg-red-50 hover:text-black underline hover:no-underline transition p-4">SHOP NOW</Link>
                        </div>
                        <div className="relative card2 row-span-2   p-12">
                              ...
                              <Link to="/catalog" className="text-white font-bold absolute left-4 top-20 hover:bg-red-50 hover:text-black underline hover:no-underline transition p-4">SHOP NOW</Link>
                        </div>
                        <div className="relative card3 row-span-3   p-24">
                              ...
                              <Link to="/catalog" className="text-white font-bold absolute left-4 top-24 hover:bg-red-50 hover:text-black underline hover:no-underline transition p-4">SHOP NOW</Link>
                        </div>
