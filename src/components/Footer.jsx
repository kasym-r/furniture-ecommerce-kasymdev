...
const Footer = () => {
  return <footer className='bg-red-200 pt-4 pb-24 md:py-12 px-4 md:gap-4 lg:gap-20 lg:px-12 flex justify-around items-center flex-wrap'>
    <div className=' flex flex-col justify-center  items-center md:mr-8 mb-8'>
        ...
        <p className="text-gray-900 mb-2 mt-8 text-lg"><i className="mr-4 fas fa-map-marker"></i>Akhunbaev Street, Bishkek, Kyrgyzstan</p>
        <p className="text-gray-900 mb-2 text-lg"><i className="mr-4 fas fa-at"></i>sofashopbishkek@gmail.com</p>
        <p className="text-gray-900 text-lg"><i className="mr-4 fas fa-phone"></i> +996999999999</p>
    </div>
