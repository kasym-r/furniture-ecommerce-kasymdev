          ...
          <div className="w-full sm:w-2/3 lg:w-1/2 flex items-center p-4 sm:p-8 lg:pl-10">
            <div className="w-full flex sm:block flex-col items-center">
              <div className="mb-4 sm:mb-8">
                <h2 className="text-gray-900 text-xl sm:text-2xl lg:text-3xl font-bold text-center sm:text-left">
              ...
              >
                ...
                <button className="inline-block bg-gray-900 hover:bg-gray-600 text-white text-sm md:text-base font-semibold text-center rounded outline-none transition duration-100 px-8 py-2">
                  Send
                </button>
              </form>
